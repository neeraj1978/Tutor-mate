...
import { GraduationCap, User, Mail, Lock, ArrowRight, Loader2, ChevronDown } from 'lucide-react';
...
const Register = ({ onRegister, onSwitchToLogin }) => {
    ...
    const [gradeLevel, setGradeLevel] = useState('College Year 1');
    ...
    const gradeOptions = [
        ...
        "College Year 1", "College Year 2", "College Year 3", "College Year 4", "Masters/PhD"
    ];
            ...
            >
                <div className="p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-500 mt-2">Join TutorMate and start learning smarter</p>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="w-full pl-10 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all appearance-none bg-white cursor-pointer"
                                >
